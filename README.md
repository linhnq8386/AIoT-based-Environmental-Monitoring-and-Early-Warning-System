...
*(Hệ thống AIoT Giám sát và Cảnh báo sớm thông số môi trường)*
...
# hoặc
node server.js
3. Khởi chạy WebGIS Dashboard UI/UX (Frontend)
Đây là mã nguồn giao diện người dùng (UI/UX) cho WebGIS Dashboard. Bản thiết kế gốc của dự án có sẵn trên nền tảng Figma tại: [WebGIS-Dashboard-UI-UX](https://www.figma.com/design/tFmI5MdL8iBPvAd8XwqBsl/WebGIS-Dashboard-UI-UX).

```bash
# Cài đặt các thư viện phụ thuộc
npm i

# Khởi chạy máy chủ phát triển (Vite/React)
npm run dev
...
Đồ án Tốt nghiệp - Ngành Công nghệ Thông tin (Niên khóa 2022 - 2026)
...
Dự án được phát triển nhằm mục đích nghiên cứu và bảo vệ đồ án tốt nghiệp. 